...
import abstract2 from '../../assets/imgs/abstract2.png';
import illustration from '../../assets/imgs/illustration.png';

const createData = (imgUrl, productName, productDesc, stock, price, totalSales) => {
  return { imgUrl, productName, productDesc, stock, price, totalSales };
};

const rows = [
  createData(abstract, 'Abstract 3D', 'Lorem ipsum dollar text sample', '32 in stock', '$ 44.99', '20'),
  createData(illustration, 'Sarphens Illustration', 'Text sample Lorem ipsum dollar', '32 in stock', '$ 44.99', '20'),
  createData(abstract2, 'Abstract 2', 'Lorem ipsum dollar text sample', '32 in stock', '$ 44.99', '20'),
];
