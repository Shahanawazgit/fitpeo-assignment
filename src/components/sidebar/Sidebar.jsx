...
import { AiOutlineDown, AiOutlineMenu, AiOutlineRight, AiOutlineClose } from 'react-icons/ai';
import './Sidebar.css';
...
const Sidebar = () => {
  ...
  return (
    <>
      <div className="bars" onClick={() => setExpanded(!expanded)} style={expanded ? { left: '185px' } : { left: '20px' }}>
